...
export function Step3DataSubjects({ values, onChange }: Props) {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold text-gray-900">Paso 3: Titulares</h3>

      {values.dataSubjects.length === 0 && (
        <p className="text-sm text-gray-500">No hay titulares registrados. Agregue al menos uno.</p>
      )}
